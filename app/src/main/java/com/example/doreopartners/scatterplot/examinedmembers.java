...
//this is the activity you go to after selecting the examinedtg. the corresponding recycler is examinedmemberrycler which is directly above it
...
public class examinedmembers extends AppCompatActivity {
