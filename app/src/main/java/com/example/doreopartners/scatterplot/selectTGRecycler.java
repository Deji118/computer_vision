...
public class selectTGRecycler extends RecyclerView.Adapter<selectTGRecycler.ViewHolder> {
    ...
    private List<modelselectTG> member_list;


    public selectTGRecycler(ArrayList<modelselectTG> memberList,Context context) {
...
//        phonenumber1=phonenumber2;
    ...
    public ViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(parent.getContext()).inflate(R.layout.selecttgrecyclerlayout,parent,false);
...
//                    String iknumber=model.getik_number();
                    ...
                    Intent intent= new Intent(mContext,selectmember.class);
                    intent.putExtra("ik_number",iknumber);
                    Toast.makeText(mContext,iknumber, Toast.LENGTH_SHORT).show();
                    OnlineDatabase db = new OnlineDatabase(mContext);
